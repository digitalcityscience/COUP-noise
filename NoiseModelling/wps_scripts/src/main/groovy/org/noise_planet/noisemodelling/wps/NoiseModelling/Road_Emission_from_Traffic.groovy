...
def exec(Connection connection, input) {
    ...
    // Create table
    createTableQuery = new StringBuilder(createTableQuery.toString()[0..-3]) // remove last comma
    createTableQuery.append(");")
    sql.execute(createTableQuery.toString())

    // Prepared insert query
    preparedInsertQuery = new StringBuilder(preparedInsertQuery.toString()[0..-3]) // remove last comma
